...
<section class="content-block container">
    ...
    <main class="container">
        ...
        <!---- Author navigation ----->
                ...
                <section class="author-content__block container_flex">
                    ...
                    <div class="subscriptions recommended__channels">
                        <h4 class="subscriptions__list__header">Recommended channel</h4>
                        <div class="subscriptions__list">
                            <a href="#" class="subscriptions__link">
                                <div class="subscriptions__link__icon">
                                    <img src="assets/img/subscriptions/francis.png" alt="francis" class="subscriptions__link__img">
                                </div>
                                <h5 class="subscriptions__link__text">
                                    Nora Francis
                                </h5>
                            </a>
                            <a href="#" class="subscriptions__link">
